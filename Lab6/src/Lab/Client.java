...
public class Client {
    public static void main(String[] args) throws IOException,ClassNotFoundException{
        ...
        CommandPackage firstset = new CommandPackage("Ticket.csv",true);
        ...
        set:while(selector.select() > 0){
            ...
            while (iterator.hasNext()){
                ...
                if(selectionKey.isReadable()){
                    ...
                    collectionofTicket.setTickets(firstResopne.getTickets());
        ...
        for(Ticket T: collectionofTicket.getTickets()){
            ...
            if (selector.select() > 0) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (key.isWritable()) {
                        ...
                        String[] commarg = tools.tools.Input().split(" ");
                            ...
                            if ((abstractCommand = commandIterator.next()).getName().equalsIgnoreCase(commarg[0])) {
                                ...
                                try {
                                    ...
                                    if (!command.getName().equalsIgnoreCase("executeScript")) {
                                        ...
                                        commandPackage = packcommand(commarg, commandManager, commandPackage, command,"Ticket.csv");
                                        ...
                                        while(commandIterator1.hasNext()){
                                            packageList.add(packcommand(stringIterator.next().split(" "),commandManager,new CommandPackage(),commandIterator1.next(),"Ticket.csv"));
                                        }
                        ...
                        Ticket.setId(Long.valueOf(response.getId()));
    ...
    public static CommandPackage packcommand(String [] commarg,CommandManager commandManager,CommandPackage commandPackage,AbstractCommand command,String FileName) throws IOException,ParaInapproException{
        if (commarg.length == 2) {
            ...
            if (name.equals(new Add().getName()) || name.equals(new Clear().getName()) || name.equals(new Exit().getName()) || name.equals(new Help().getName()) || name.equals(new History().getName()) || name.equals(new Info().getName()) ||  name.equals(new Show().getName()) || name.equals(new Save().getName())) {
            ...
            if (commarg[0].equalsIgnoreCase("Removebyid")) {
                try {
                    Ticket T = commandManager.findByid(Long.valueOf(commarg[1]));
                    commandPackage = new CommandPackage(command, T,FileName);

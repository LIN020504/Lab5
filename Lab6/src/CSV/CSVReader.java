...
public class CSVReader {
     ...
     * @param ticketslinkedhashset
     * @param path
     * @throws IOException
     * @return
     */
    public LinkedHashSet<Ticket> ReadFile(LinkedHashSet<Ticket> ticketslinkedhashset, String path) throws IOException{
        ...
        while((s = bufferedReader.readLine())!=null) {
            ...
            ticketslinkedhashset.add(t);
        }
        return ticketslinkedhashset;
    }
}
